...
@Tag(name="파일 API", description = "파일 업로드, 다운로드, 조회 기능을 제공")
public class FileController {
    ...
    @Operation(summary = "파일 업로드 처리", method = "NULTIPART")
    @ApiResponse(responseCode = "201", description = "파일 업로드 성공 시 업로드한 파일 목록이 출력")
    @PostMapping("/upload")
    ...
    @Operation(summary = "파일 등록 번호로 파일 정보 1개 조회")
    @Parameters({
