...
public class RestaurantInfoService {
     ...
     * @return
     */
    public List<Restaurant> getNearest(double lat, double lon, int cnt) {
        ...
        if (isProduction) { // 리눅스 환경, 서비스 환경
            activationCommand = String.format("source %s/activate", properties.getBase2());
